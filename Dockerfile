...
RUN export TZ=Europe/Rome && \
	...
	wget -q -nc --show-progress --progress=bar:force:noscroll -O MegaSync.deb hhttps://mega.nz/linux/MEGAsync/Debian_testing/amd64/megasync_${MEGASYNC_CLIENT_VERSION}_amd64.deb && \
	dpkg -i MegaSync.deb && \
