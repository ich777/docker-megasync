...
RUN export TZ=Europe/Rome && \
	...
	wget -q -nc --show-progress --progress=bar:force:noscroll -O MegaSync.deb https://mega.nz/linux/MEGAsync/Debian_${DEBIAN_V}/amd64/megasync_${MEGASYNC_CLIENT_VERSION}_amd64.deb && \
	dpkg -i MegaSync.deb && \
